...
class TrainWrapper(TrainWrapperBaseClass):
    ...
    def __init__(self, args, config):
        ...
        self.body_queue = torch.zeros((0, 512), dtype=torch.float)
        self.lhand_queue = torch.zeros((0, 128), dtype=torch.float)
        self.rhand_queue = torch.zeros((0, 128), dtype=torch.float)
